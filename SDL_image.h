...
/* $Id: SDL_image.h,v 1.12 2001/12/14 13:02:16 slouken Exp $ */
...
extern DECLSPEC int IMG_isJP2(SDL_RWops *src);
extern DECLSPEC int IMG_isRAS(SDL_RWops *src);
extern DECLSPEC int IMG_isRAW(SDL_RWops *src);
...
extern DECLSPEC SDL_Surface *IMG_LoadJP2_RW(const char *file);
extern DECLSPEC SDL_Surface *IMG_LoadRAS_RW(SDL_RWops *src);
extern DECLSPEC SDL_Surface *IMG_LoadRAW_RW(SDL_RWops *src);

extern DECLSPEC SDL_Surface *IMG_ReadXPMFromArray(char **xpm);
/*
extern DECLSPEC jas_image_t *jp2_decode(jas_stream_t *in, char *optstr);
extern DECLSPEC jas_stream_t *jas_stream_fopen(const char *filename, const char *mode);
extern DECLSPEC void jas_matrix_destroy(jas_matrix_t *matrix);
extern DECLSPEC jas_matrix_t *jas_matrix_create(int numrows, int numcols);
extern DECLSPEC int jas_image_readcmpt(jas_image_t *image, uint_fast16_t cmptno,
